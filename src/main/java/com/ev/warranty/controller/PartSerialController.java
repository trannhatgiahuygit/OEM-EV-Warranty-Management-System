...
public class PartSerialController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_EVM_STAFF', 'ROLE_SC_STAFF')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_EVM_STAFF', 'ROLE_SC_STAFF', 'ROLE_SC_TECHNICIAN')")
    ...
    @PostMapping("/install")
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_SC_TECHNICIAN', 'ROLE_SC_STAFF')")
