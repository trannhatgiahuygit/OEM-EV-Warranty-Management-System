@echo off
REM Script to commit all changes from yesterday to now
...
REM Add modified files (main changes from yesterday)
...
REM Add other modified files (if you want to include all changes)
