...
public class ServiceCatalogController {
    ...
    @Operation(summary = "Get current price for item",
               description = "Get current effective price for a specific part or service. " +
                           "If region and serviceCenterId are not provided, they will be automatically " +
                           "detected from the authenticated user's service center and region.")
    public ResponseEntity<CatalogPriceResponseDTO> getCurrentPriceForItem(
            @PathVariable String itemType,
            @PathVariable Integer itemId,
            @Parameter(description = "Region (NORTH/SOUTH/CENTRAL). Optional - auto-detected from user's service center if not provided")
            @RequestParam(required = false) String region,
            @Parameter(description = "Service center ID. Optional - auto-detected from authenticated user if not provided")
    ...
    @Operation(summary = "Calculate service estimate",
               description = "Calculate total estimate for parts and services. " +
                           "If region and serviceCenterId are not provided in the request, they will be automatically " +
                           "detected from the authenticated user's service center and region.")
