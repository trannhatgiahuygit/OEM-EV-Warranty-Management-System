...
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'PENDING_CUSTOMER_APPROVAL')
    INSERT INTO claim_statuses (code, label) VALUES ('PENDING_CUSTOMER_APPROVAL', N'Chờ khách hàng xác nhận');
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'CUSTOMER_APPROVED_THIRD_PARTY')
    INSERT INTO claim_statuses (code, label) VALUES ('CUSTOMER_APPROVED_THIRD_PARTY', N'Khách đồng ý linh kiện bên thứ 3');
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'CUSTOMER_ACTION_NEEDED')
    INSERT INTO claim_statuses (code, label) VALUES ('CUSTOMER_ACTION_NEEDED', N'Cần Hành động Khách hàng');
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'MOVE_ON_SC_REPAIR')
    INSERT INTO claim_statuses (code, label) VALUES ('MOVE_ON_SC_REPAIR', N'Chuyển sang Sửa chữa SC');

-- ===== NOTE: Cost columns (total_service_cost, total_third_party_parts_cost, total_estimated_cost) 
-- ===== are created by Hibernate schema generation, so no need to add them here

-- NEW STATUSES for repair workflow
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'CUSTOMER_PAYMENT_PENDING')
    INSERT INTO claim_statuses (code, label) VALUES ('CUSTOMER_PAYMENT_PENDING', N'Chờ thanh toán từ khách hàng');
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'CUSTOMER_PAID')
    INSERT INTO claim_statuses (code, label) VALUES ('CUSTOMER_PAID', N'Khách hàng đã thanh toán');
IF NOT EXISTS (SELECT 1 FROM claim_statuses WHERE code = 'WORK_DONE')
    INSERT INTO claim_statuses (code, label) VALUES ('WORK_DONE', N'Công việc sửa chữa hoàn thành');
...
-- THIRD-PARTY PARTS (for each service center) - Quantity matches number of AVAILABLE serials (5 serials = quantity 5)
-- Service Center 1 (SC-HCM-001) - SOUTH region
...
('TP-HCM-001', 'Battery Charger Adapter', 'Charging', 'Third-party fast charger adapter compatible with CCS Type 2', 'TechParts Co.', 250000, 5, 1, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-HCM-002', 'Floor Mats Set', 'Interior', 'Premium all-weather floor mats for EV models', 'AutoAccessories Ltd.', 120000, 5, 1, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-HCM-003', 'Tire Pressure Sensor', 'Safety', 'Aftermarket TPMS sensor compatible with EV systems', 'SafeDrive Parts', 85000, 5, 1, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin');

-- Service Center 2 (SC-HN-001) - NORTH region
INSERT INTO third_party_parts (part_number, name, category, description, supplier, unit_cost, quantity, service_center_id, active, created_at, updated_at, updated_by) VALUES
('TP-HN-001', 'LED Headlight Bulb', 'Lighting', 'High-performance LED replacement bulbs', 'BrightLights Inc.', 150000, 5, 2, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-HN-002', 'Cabin Air Filter', 'HVAC', 'Premium HEPA cabin air filter', 'CleanAir Filters', 45000, 5, 2, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-HN-003', 'Wiper Blades Set', 'Exterior', 'Aero wiper blades for improved visibility', 'RainClear Parts', 35000, 5, 2, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin');

-- Service Center 3 (SC-DN-001) - CENTRAL region
INSERT INTO third_party_parts (part_number, name, category, description, supplier, unit_cost, quantity, service_center_id, active, created_at, updated_at, updated_by) VALUES
('TP-DN-001', 'Charging Cable Extension', 'Charging', '10-meter extension cable for home charging', 'ChargePro Solutions', 180000, 5, 3, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-DN-002', 'Dashboard Cover', 'Interior', 'UV protection dashboard cover', 'SunShield Auto', 95000, 5, 3, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin'),
('TP-DN-003', 'Brake Pad Set (Front)', 'Brakes', 'Ceramic brake pads for improved stopping power', 'BrakeTech Industries', 220000, 5, 3, 1, '2023-01-15 08:00:00', '2023-01-15 08:00:00', 'admin');
...
-- Third-Party Parts Regional Pricing (Service Center 1 - SC-HCM-001, SOUTH region)
-- Part ID 1: TP-HCM-001 (Battery Charger Adapter)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 1, 250000, 'VND', 'NORTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 1, 250000, 'VND', 'SOUTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 1, 255000, 'VND', 'CENTRAL', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 2: TP-HCM-002 (Floor Mats Set)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 2, 120000, 'VND', 'NORTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 2, 120000, 'VND', 'SOUTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 2, 125000, 'VND', 'CENTRAL', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 3: TP-HCM-003 (Tire Pressure Sensor)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 3, 85000, 'VND', 'NORTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 3, 85000, 'VND', 'SOUTH', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 3, 88000, 'VND', 'CENTRAL', 1, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Third-Party Parts Regional Pricing (Service Center 2 - SC-HN-001, NORTH region)
-- Part ID 4: TP-HN-001 (LED Headlight Bulb)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 4, 150000, 'VND', 'NORTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 4, 155000, 'VND', 'SOUTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 4, 152000, 'VND', 'CENTRAL', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 5: TP-HN-002 (Cabin Air Filter)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 5, 45000, 'VND', 'NORTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 5, 47000, 'VND', 'SOUTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 5, 46000, 'VND', 'CENTRAL', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 6: TP-HN-003 (Wiper Blades Set)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 6, 35000, 'VND', 'NORTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 6, 36000, 'VND', 'SOUTH', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 6, 35500, 'VND', 'CENTRAL', 2, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Third-Party Parts Regional Pricing (Service Center 3 - SC-DN-001, CENTRAL region)
-- Part ID 7: TP-DN-001 (Charging Cable Extension)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 7, 185000, 'VND', 'NORTH', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 7, 180000, 'VND', 'SOUTH', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 7, 180000, 'VND', 'CENTRAL', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 8: TP-DN-002 (Dashboard Cover)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 8, 98000, 'VND', 'NORTH', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 8, 95000, 'VND', 'SOUTH', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
('THIRD_PARTY_PART', 8, 95000, 'VND', 'CENTRAL', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part ID 9: TP-DN-003 (Brake Pad Set)
INSERT INTO catalog_prices (item_type, item_id, price, currency, region, service_center_id, effective_from, effective_to, created_at, updated_at) VALUES
('THIRD_PARTY_PART', 9, 225000, 'VND', 'NORTH', 3, '2024-01-01', NULL, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
...
(1, 'TP-HCM-001-SN-001', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(1, 'TP-HCM-001-SN-002', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(1, 'TP-HCM-001-SN-003', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(1, 'TP-HCM-001-SN-004', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(1, 'TP-HCM-001-SN-005', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 2: TP-HCM-002 (Floor Mats Set)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(2, 'TP-HCM-002-SN-001', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(2, 'TP-HCM-002-SN-002', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(2, 'TP-HCM-002-SN-003', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(2, 'TP-HCM-002-SN-004', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(2, 'TP-HCM-002-SN-005', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 3: TP-HCM-003 (Tire Pressure Sensor)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(3, 'TP-HCM-003-SN-001', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(3, 'TP-HCM-003-SN-002', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(3, 'TP-HCM-003-SN-003', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(3, 'TP-HCM-003-SN-004', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(3, 'TP-HCM-003-SN-005', 'AVAILABLE', 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Serials for existing parts (Service Center 2 - Parts 4-6)
-- Part 4: TP-HN-001 (LED Headlight Bulb)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(4, 'TP-HN-001-SN-001', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(4, 'TP-HN-001-SN-002', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(4, 'TP-HN-001-SN-003', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(4, 'TP-HN-001-SN-004', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(4, 'TP-HN-001-SN-005', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 5: TP-HN-002 (Cabin Air Filter)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(5, 'TP-HN-002-SN-001', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(5, 'TP-HN-002-SN-002', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(5, 'TP-HN-002-SN-003', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(5, 'TP-HN-002-SN-004', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(5, 'TP-HN-002-SN-005', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 6: TP-HN-003 (Wiper Blades Set)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(6, 'TP-HN-003-SN-001', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(6, 'TP-HN-003-SN-002', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(6, 'TP-HN-003-SN-003', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(6, 'TP-HN-003-SN-004', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(6, 'TP-HN-003-SN-005', 'AVAILABLE', 2, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Serials for existing parts (Service Center 3 - Parts 7-9)
-- Part 7: TP-DN-001 (Charging Cable Extension)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(7, 'TP-DN-001-SN-001', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(7, 'TP-DN-001-SN-002', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(7, 'TP-DN-001-SN-003', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(7, 'TP-DN-001-SN-004', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(7, 'TP-DN-001-SN-005', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 8: TP-DN-002 (Dashboard Cover)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(8, 'TP-DN-002-SN-001', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(8, 'TP-DN-002-SN-002', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(8, 'TP-DN-002-SN-003', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(8, 'TP-DN-002-SN-004', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(8, 'TP-DN-002-SN-005', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00');

-- Part 9: TP-DN-003 (Brake Pad Set)
INSERT INTO third_party_part_serials (third_party_part_id, serial_number, status, service_center_id, created_at, updated_at) VALUES
(9, 'TP-DN-003-SN-001', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(9, 'TP-DN-003-SN-002', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
(9, 'TP-DN-003-SN-003', 'AVAILABLE', 3, '2024-01-01 08:00:00', '2024-01-01 08:00:00'),
...
-- Quantity = number of AVAILABLE serials for each part
-- This ensures quantity matches the actual number of AVAILABLE serials
-- ============================================
UPDATE third_party_parts
SET quantity = (
    SELECT COUNT(*) 
    FROM third_party_part_serials 
    WHERE third_party_part_serials.third_party_part_id = third_party_parts.id 
    AND third_party_part_serials.status = 'AVAILABLE'
),
updated_at = GETDATE(),
updated_by = 'admin'
WHERE EXISTS (
...
-- ============================================
-- TEST DATA FOR AUTOMATIC WARRANTY CONDITION EVALUATION FLOW
-- ============================================
...
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(1, 3, 100000, 'Previous warranty period: 3 years or 100,000 km. This condition has expired.', '2021-01-01', '2023-12-31', 0, '2021-01-01 08:00:00', '2023-12-31 23:59:59', 'admin');

-- Model 2: EV-Y-STD-2023 - Add conditions with different mileage limits
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(2, 3, 80000, 'Limited warranty: 3 years or 80,000 km for basic components only.', '2023-06-01', NULL, 1, '2023-06-01 08:00:00', '2023-06-01 08:00:00', 'admin'),
(2, 2, 50000, 'Short warranty: 2 years or 50,000 km for promotional models.', '2023-01-01', '2023-05-31', 0, '2023-01-01 08:00:00', '2023-05-31 23:59:59', 'admin');

-- Model 3: EV-Z-LUX-2024 - Add premium conditions
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(3, 5, 150000, 'Premium extended warranty: 5 years or 150,000 km comprehensive coverage.', '2024-06-01', NULL, 1, '2024-06-01 08:00:00', '2024-06-01 08:00:00', 'admin');

-- Model 4: EV-X-PRO-2023 - Warranty conditions
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(4, 3, 100000, 'Standard warranty for 2023 model: 3 years or 100,000 km.', '2023-01-01', NULL, 1, '2023-01-01 08:00:00', '2023-01-01 08:00:00', 'admin'),
(4, 3, 120000, 'Extended warranty option: 3 years or 120,000 km for early adopters.', '2023-01-01', '2023-03-31', 0, '2023-01-01 08:00:00', '2023-03-31 23:59:59', 'admin');

-- Model 5: EV-Y-STD-2024 - Warranty conditions
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(5, 3, 100000, 'Standard warranty for 2024 model: 3 years or 100,000 km.', '2024-01-01', NULL, 1, '2024-01-01 08:00:00', '2024-01-01 08:00:00', 'admin');

-- Model 6: EV-Z-LUX-2023 - Warranty conditions
INSERT INTO warranty_conditions (vehicle_model_id, coverage_years, coverage_km, conditions_text, effective_from, effective_to, active, created_at, updated_at, updated_by) VALUES
(6, 4, 120000, 'Luxury warranty for 2023 model: 4 years or 120,000 km.', '2023-01-01', NULL, 1, '2023-01-01 08:00:00', '2023-01-01 08:00:00', 'admin');
...
UPDATE vehicles SET vehicle_model_id = 1 WHERE model = 'EV Model X Pro' AND vehicle_model_id IS NULL;
UPDATE vehicles SET vehicle_model_id = 2 WHERE model = 'EV Model Y Standard' AND vehicle_model_id IS NULL;
UPDATE vehicles SET vehicle_model_id = 3 WHERE model = 'EV Model Z Luxury' AND vehicle_model_id IS NULL;

-- ============================================
-- SUMMARY OF TEST DATA ADDED
-- ============================================
-- Vehicle Models Added: 3 new models (IDs 4, 5, 6)
--   - EV-X-PRO-2023, EV-Y-STD-2024, EV-Z-LUX-2023
--
-- Warranty Conditions Added: 9 new conditions covering:
--   - Expired warranty conditions (for testing expiry logic)
--   - Different mileage limits (50k, 80k, 100k, 120k, 150k km)
--   - Different time periods (2, 3, 4, 5, 8 years)
--   - Active and inactive conditions
--
-- Test Vehicles Added: 18 vehicles (TEST-VIN-001 to TEST-VIN-018) covering:
--   Scenario 1: IN WARRANTY (3 vehicles) - Within time and mileage limits
--   Scenario 2: OUT OF WARRANTY - Expired Time (3 vehicles) - Warranty expired
--   Scenario 3: OUT OF WARRANTY - Exceeded Mileage (3 vehicles) - Over mileage limit
--   Scenario 4: NEAR WARRANTY EXPIRY (3 vehicles) - Expiring within 3 months
--   Scenario 5: HIGH MILEAGE but WITHIN WARRANTY (3 vehicles) - Close to mileage limit
--   Scenario 6: LOW MILEAGE NEW VEHICLES (3 vehicles) - Recently registered
--
-- Test Claims Added: 18 claims (TEST-CLM-001 to TEST-CLM-018) - One claim per test vehicle
--   These claims can be used to test the automatic warranty condition evaluation flow
